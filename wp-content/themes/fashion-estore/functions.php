...
add_action('after_switch_theme', 'fashion_estore_setup_options');

function fashion_estore_setup_options () {
	wp_redirect( admin_url() . 'themes.php?page=fashion-estore-info.php' );
}
 ...
 */
add_filter('loop_shop_columns', 'fashion_estore_loop_columns', 999);
...
function add_news_init(){

	$args = array('public'=>true, 'label'=>'News','taxonomies'=>array('category','post_tag'));

	register_post_type('news_hoooks',$args);
}

add_action('init','add_news_init');
